	...
	<div class="row">
		...
		<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
			<div class="form-group">
				...
				<input class="form-control" type="text" name="serie_comprobante" value="{{old('serie_comprobante')}}" placeholder=" Serie Comprobante...">
			</div>
		</div>
		<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
			<div class="form-group">
				<label for="num_comprobante">Numero Comprobante</label>
				<input class="form-control" type="text" name="num_comprobante" value="{{old('num_comprobante')}}" placeholder=" Numero Comprobante..." required>
			</div>
		</div>
	</div>
	<div class="row">
				...
				<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
					<table class="table table-striped table-bordered table-condensed table-hover" id="detalles">
						...
						<tfoot>
							...
							<th></th>
							<th></th>
							<th><h4 id="total">S/. 0.00</h4><input type="hidde" name="total_venta" id="total_venta"></th>
						</tfoot>
					</table>
				</div>
			</div>
